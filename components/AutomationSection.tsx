...
const AutomationSection: React.FC = () => {
  ...
  useGSAP(() => {
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        trigger: container,
        start: 'top top',
        end: '+=150%', // Allow time for reading and sequential animations
        pin: true,
        scrub: 1,
        anticipatePin: 1
      }
    ...
    tl.to('.automation-line', {
      height: '4rem', // Adjust based on design needs
      duration: 0.5,
      ease: 'power2.out'
    }, 0);
    ...
    tl.fromTo(coreValueLines,
        ...
        1.2 // Starts after bullets begin finishing
    );
  ...
  return (
    <section 
      ref={containerRef} 
      className="relative w-full h-screen bg-[#050505] text-[#e0e0e0] py-24 px-6 md:px-16 lg:px-24 flex flex-col justify-between overflow-hidden"
    >
       ...
       <div className="w-full">
           ...
           <div className="flex flex-col items-start mb-12 relative pl-1">
              ...
              <div className="pl-6 pt-2">
                <h3 className="automation-label font-mono text-xs md:text-sm tracking-[0.2em] text-red-600 font-bold overflow-hidden">
       ...
       <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 mt-12 lg:mt-0 items-end">
           ...
           <div className="lg:col-span-7 flex flex-col justify-end pb-2">
               <div className="font-sans font-bold text-2xl md:text-4xl lg:text-5xl leading-tight text-white/95 tracking-tight">
                   <div className="overflow-hidden">
                       <p className="core-value-line block">A SINGLE DASHBOARD THAT GIVES YOU</p>
                   </div>
                   <div className="overflow-hidden">
                       <p className="core-value-line block">VISIBILITY, CONTROL, AND REAL-TIME</p>
                   </div>
                   <div className="overflow-hidden">
                       <p className="core-value-line block">INFLUENCE OVER THE WORK.</p>
                   </div>
               </div>
           </div>
       </div>
